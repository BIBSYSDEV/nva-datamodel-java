...
@JsonTypeName(no.unit.nva.model.associatedartifacts.file.AdministrativeAgreement.TYPE)
public class UnpublishableFile extends File {
     ...
     */
    @JsonCreator
    public UnpublishableFile(@JsonProperty(IDENTIFIER_FIELD) UUID identifier,
