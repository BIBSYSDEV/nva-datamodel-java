...
public class InstanceTypeProvider implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext context) {
        return Stream.of(
                ...
                Arguments.of("MediaNewspaper"),
                Arguments.of("MediaJournal"),
                Arguments.of("MediaRadio"),
                Arguments.of("MediaTelevision"),
                Arguments.of("MediaInternet"),
                Arguments.of("MediaOther"),
