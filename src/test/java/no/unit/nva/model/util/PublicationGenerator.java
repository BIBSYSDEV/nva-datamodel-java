...
public class PublicationGenerator {
    ...
    private static BaseContext getPublishingContextBook() throws InvalidIsbnException {
    ...
    public static BaseContext getPublishingContextJournal() throws InvalidIssnException {
